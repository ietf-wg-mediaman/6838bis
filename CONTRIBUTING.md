...
Discussion of this work occurs on the [Media Type Maintenance
Working Group mailing list](mailto:media-types@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/media-types/),
[subscribe](https://www.ietf.org/mailman/listinfo/media-types)).
...
[Working Group documents](https://datatracker.ietf.org/wg/mediaman/documents/).
